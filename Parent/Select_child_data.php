          ...
          if ($cid_query) {
            ...
            if ($cid_query) {
                ...
                if ($IPV2 == 0) {
                    ...
                    if (!empty($IPV_dose2_date)) {
                        ...
                        $update_child_vaccine_status = "UPDATE child_vaccine_status SET dosage_status = 2 , status = 2 WHERE cid = $lastid AND vac_name = 'IPV2'"; 
                        mysqli_query($conn,$update_child_vaccine_status); 
                ...
                if ($IPV3 == 0) {
                    ...
                    if (!empty($IPV_dose3_date)) {
                        ...
                        $update_child_vaccine_status = "UPDATE child_vaccine_status SET dosage_status = 3 , status = 2 WHERE cid = $lastid AND vac_name = 'IPV3'"; 
                        mysqli_query($conn,$update_child_vaccine_status);  
            ...
            if ($cid_query) {
                ...
                if ($PCV1 == 0) {
                    ...
                    if (!empty($PCV_dose1_date)) {
                        ...
                        $update_child_vaccine_status = "UPDATE child_vaccine_status SET dosage_status = 1 , status = 2 WHERE cid = $lastid AND vac_name = 'PCV1'"; 
                        mysqli_query($conn,$update_child_vaccine_status);  
                ...
                if ($PCV2 == 0) {
                    ...
                    if (!empty($PCV_dose2_date)) {
                        ...
                        $update_child_vaccine_status = "UPDATE child_vaccine_status SET dosage_status = 2 , status = 2 WHERE cid = $lastid AND vac_name = 'PCV2'";
                        mysqli_query($conn,$update_child_vaccine_status);  
                ...
                if ($PCV3 == 0) {
                    ...
                    if (!empty($PCV_dose3_date)) {
                        ...
                        $update_child_vaccine_status = "UPDATE child_vaccine_status SET dosage_status = 3 , status = 2 WHERE cid = $lastid AND vac_name = 'PCV3'"; 
                        mysqli_query($conn,$update_child_vaccine_status);  
            ...
            if ($cid_query) {
                ...
                if ($RTAV1 == 0) {
                    ...
                    if (!empty($RTAV_dose1_date)) {
                        ...
                        $update_child_vaccine_status = "UPDATE child_vaccine_status SET dosage_status = 1 , status = 2 WHERE cid = $lastid AND vac_name = 'Rotavirus1'"; //Wala sa table
                        mysqli_query($conn,$update_child_vaccine_status);  
                ...
                if ($RTAV2 == 0) {
                    ...
                    if (!empty($RTAV_dose2_date)) {
                        ...
                        $update_child_vaccine_status = "UPDATE child_vaccine_status SET dosage_status = 2 , status = 2 WHERE cid = $lastid AND vac_name = 'Rotavirus2'"; //Wala sa table
                        mysqli_query($conn,$update_child_vaccine_status);  
                ...
                if ($RTAV3 == 0) {
                    ...
                    if (!empty($RTAV_dose3_date)) {
                        ...
                        $update_child_vaccine_status = "UPDATE child_vaccine_status SET dosage_status = 3 , status = 2 WHERE cid = $lastid AND vac_name = 'Rotavirus3'"; 
                        mysqli_query($conn,$update_child_vaccine_status);  
            ...
            if ($MM1 == 0) {
                ...
                if (!empty($MMR_dose1_date)) {
                    ...
                    $update_child_vaccine_status = "UPDATE child_vaccine_status SET dosage_status = 1 , status = 2 WHERE cid = $lastid AND vac_name = 'MMR'"; 
                    mysqli_query($conn,$update_child_vaccine_status);  
                    add_last_vaccine_details($userid, $lastid , 'MMR1', $MMR_dose1_date , 1, $child_name  , 2);
                } else {
                    $mr1 = "INSERT INTO `vac_measles_table`(`cid`, `dose1`) VALUES ('$cid', '$MM1')";
                }
                $conn->query($mr1);
            ...
            if ($MM2 == 0) {
                ...
                if (!empty($MMR_dose2_date)) {
                    ...
                    $update_child_vaccine_status = "UPDATE child_vaccine_status SET dosage_status = 2 , status = 2 WHERE cid = $lastid AND vac_name = 'MMR2'"; 
                    mysqli_query($conn,$update_child_vaccine_status);  
        ...
        if ($cid_query) {
            ...
            if ($FLU1 == 0) {
                ...
                if (!empty($FLU_dose1_date)) {
                    ...
                    $update_child_vaccine_status = "UPDATE child_vaccine_status SET dosage_status = 1 , status = 2 WHERE cid = $lastid AND vac_name = 'Influenza'"; //Wala sa table
                    mysqli_query($conn,$update_child_vaccine_status);  
            ...
            if ($FLU2 == 0) {
                ...
                if (!empty($FLU_dose2_date)) {
                    ...
                    $update_child_vaccine_status = "UPDATE child_vaccine_status SET dosage_status = 2 , status = 2 WHERE cid = $lastid AND vac_name = 'Influenza2'"; //Wala sa table
                    mysqli_query($conn,$update_child_vaccine_status);  
        ...
        if ($cid_query) {
            ...
            if ($HEPA1 == 0) {
                ...
                if (!empty($HEPA_dose1_date)) {
                    ...
                    $update_child_vaccine_status = "UPDATE child_vaccine_status SET dosage_status = 1 , status = 2 WHERE cid = $lastid AND vac_name = 'HepA1'"; //Wala sa table
                    mysqli_query($conn,$update_child_vaccine_status);  
            ...
            if ($HEPA2 == 0) {
                ...
                if (!empty($HEPA_dose2_date)) {
                    ...
                    $update_child_vaccine_status = "UPDATE child_vaccine_status SET dosage_status = 2 , status = 2 WHERE cid = $lastid AND vac_name = 'HepA2'"; //Wala sa table
                    mysqli_query($conn,$update_child_vaccine_status);  
