...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($insert) {
        ...
        $message = "Click the following link to verify your email: http://localhost/VACCUNA/Homepage/verify-email.php?token=$token_verified";
        $headers = "From: percii6027@gmail.com"; // Change this to your email
